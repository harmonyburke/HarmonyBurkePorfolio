    ...
    return (
        <div className="projects" style={{ color:'#A1683A', margin: '0'}} >
            <ul className="list-group" style={{display:'flex', flexDirection:'column', justifyContent: 'spaceBetween', }} >
                ...
                <li style={{display:'flex', flexDirection:'column'}}><img src='/images/insomnia bug.png' style={{height:'200px', width:'200px'}}></img> E-Commerce Application: MySQL<a href='https://drive.google.com/file/d/1R-lGeW7Pv-nv1hicR6zulEbZqIzc0Zaq/view?usp=sharing'>Check out this short video walkthrough!</a> 
                <a href='https://github.com/harmonyburke/e-commerce'>Check out the Repository!</a></li>

                <li style={{display:'flex', flexDirection:'column'}}> <img src='images\beatdeetz.png' style={{height:'200px', width:'200px'}}></img> Beat Deetz <a href='https://harmonyburke.github.io/beatdeets/'>Check out the webpage!</a>
                <a href='https://github.com/harmonyburke/beatdeets'>Check out the Repository!</a></li>

                <li style={{display:'flex', flexDirection:'column'}}> <img src='images\portfolio1.png' style={{height:'200px', width:'200px'}}></img> Beginner Portfolio <a href=' https://harmonyburke.github.io/my-portfolio/'>Check out the webpage!</a>
