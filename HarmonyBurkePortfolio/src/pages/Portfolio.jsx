    ...
    return (
        <div className="projects" style={{ color:'#A1683A', margin: '0'}} >
            <ul className="list-group" style={{display:'flex', flexDirection:'row', justifyContent: 'spaceBetween',flexWrap:'wrap' }} >
                <li style={{display:'flex', flexDirection:'column', margin:'60px'}}> <img src='./public/images\pizzzapuz.png' style={{height:'200px', width:'200px'}}></img> Pizza Puzzler: The Game <a href='https://pizza-puzzler-df030c54c16c.herokuapp.com/'>Check out the game!</a>
